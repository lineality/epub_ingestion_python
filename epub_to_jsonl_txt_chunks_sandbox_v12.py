...
def save_chunks(chunks_list, output_chunks_dir, chunk_source_name):
...
def extract_text_from_epub(epub_file_path, output_jsonl_path, output_json_dir, output_whole_txt_path, output_txt_dir, output_chunks_dir, chunk_size=500):
    with zipfile.ZipFile(epub_file_path, 'r') as epub:
        ...
        for html_file in ordered_html_files:
            ...
            if full_path in epub.namelist():
                ...
                number_of_chunks = save_chunks(chunks_list, output_chunks_dir, chunk_source_name)
...
# run
extract_text_from_epub(epub_file_path, output_jsonl_path, output_json_dir, output_whole_txt_path, output_txt_dir, output_chunks_dir, chunk_size=500)
