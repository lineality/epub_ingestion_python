...
################################
source_attribution_string = input("What is your source attribution string? (e.g. title, author, publisher, year, etc.)")
...
def extract_text_from_pdf(
    ...
    if text:
        ...
        chunks_list = make_chunk_list(text, max_chunk_size, this_txt_output_dir_path, overlap_size)
